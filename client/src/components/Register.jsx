...
export default function Register() {
    ...
    return (
        <>
            ...
            <Container  fixed   className="p-3 mt-3">
                 <Box padding="3" component="form" noValidate autoComplete="off" onSubmit={userReg} >

      <div><TextField  margin="dense" type="text" name="fname" id="fname" label="First Name" variant="standard" required onChange={handler} onMouseOver={handler} inputRef={fnameInp}/>
      </div>

      <div><TextField margin="dense" type="text" name="lname" id="lname" label="Last Name" variant="standard" required onChange={handler} onMouseOver={handler} inputRef={lnameInp}/>
       </div>

      <div><TextField margin="dense" type="text" name="uname" id="uname" label="Username" variant="standard" required onChange={handler} onMouseOver={handler} inputRef={unameInp}/><br/>
      </div>

      <div><TextField margin="dense" type="text" name="email" id="email" label="Email" variant="standard" required onChange={handler} onMouseOver={handler} inputRef={emailInp}/><br/>
      {/* {errors.email.length>0 && <span style={{color:'red'}}>{errors.email}</span>}
       */}
      </div>

      <div><TextField margin="dense" type="password" name="password" id="password" label="Password" variant="standard" required onChange={handler} onMouseOver={handler} inputRef={passInp}/><br/>
      {/* {errors.password.length>0 && <span style={{color:'red'}}>{errors.password}</span>}
       */}
      </div>

      <div><TextField margin="dense" type="password" name="con_password" id="con_password" label="Confirm Password" variant="standard" required onChange={handler} inputRef={cpassInp} /><br/>
